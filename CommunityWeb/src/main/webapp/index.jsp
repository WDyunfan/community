  ...
  <div class="navbox">
    ...
    <nav>
      <ul id="starlist">
        ...
        <li class="menu"><a>我的千锋</a>
          <ul class="sub">
            <li><a href="http://localhost:8080/CommunityWeb/LeavemessageController/getLeave">留言</a></li>
            <li><a href="http://localhost:8080/CommunityWeb/ForumController/getForums">论坛问答</a></li>
              <!--<li><a href="/8">回答</a></li>-->
