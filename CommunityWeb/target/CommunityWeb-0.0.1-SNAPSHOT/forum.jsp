...
<article> 
  ...
  <div class="lbox">
    ...
    <div class="whitebg bloglist">
      <a class="biaoqian" href="/ForumController/views?type=forum_time">最新提问</a>    <a class="biaoqian" href="/ForumController/views?type=forum_pageviews">热点提问</a>    <a class="biaoqian" href="/ForumController/views?type=forum_commentvolume">热议提问</a>
      <p>=============================================================</p>
      <ul>
        <c:forEach items="${forumss }" var="foru">
        <li>
          <h1 class="blogtitle" style="font-size: 27px;"><a href="/ForumController/intoForum?forum_id=${foru.forumId }" target="_blank">${foru.forumContent}</a></h1>
          <%int i=1; %>
